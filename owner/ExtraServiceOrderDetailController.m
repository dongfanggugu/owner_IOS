//
//  ExtraServiceOrderDetailController.m
//  owner
//
...
@interface ExtraServiceOrderDetailController () <UITableViewDelegate, UITableViewDataSource>

@property (strong, nonatomic) UITableView *tableView;

@end

@implementation ExtraServiceOrderDetailController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *payType = [_orderInfo[@"incrementTypeInfo"] objectForKey:@"name"];

    cell.lbName.text = [NSString stringWithFormat:@"服务类型:%@", payType];

    cell.lbContent.text = [_orderInfo[@"incrementTypeInfo"] objectForKey:@"content"];
    ...
    CGFloat price = [[_orderInfo[@"incrementTypeInfo"] objectForKey:@"price"] floatValue];

    cell.lbPrice.text = [NSString stringWithFormat:@"￥%.2lf", price];

    cell.lbDiscourt.text = @"￥-0.00";
