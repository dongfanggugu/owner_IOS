...
@interface OrderOthersController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation OrderOthersController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    controller.houseInfo = self.arrayOrder[indexPath.section][@"villaInfo"];
